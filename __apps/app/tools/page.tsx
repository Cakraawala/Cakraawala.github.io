...
const items: {
  ...
  tags: Tag[];
    ...
    // ── Tools: Developer / Technical (toward end) ─────────────────────────
    {
        ...
        <div className="flex items-center gap-2 mb-4 flex-wrap">
          {tabs.map((tab) => (
            <button
              ...
              className={`px-4 py-1.5 rounded-full text-xs font-mono border transition-all duration-200 ${active === tab.value
          ...
          {ALL_TAGS.map((tag) => {
            ...
            return (
              <button
                ...
                className={`px-3 py-1 rounded-full text-[11px] font-mono border transition-all duration-200 ${isActive
            ...
            {filtered.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={`group relative p-5 rounded-2xl bg-surface border border-line transition-all duration-300 flex flex-col gap-3 ${item.status === "ready"
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-1 mt-1">
                    {item.tags.map((tag) => (
                      <span
                        key={tag}
                        className={`text-[9px] font-mono px-1.5 py-0.5 rounded-md border ${selectedTags.includes(tag)
